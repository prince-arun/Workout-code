...
let averageRatings = superMarket.reduce((acc, rate) => {
  return acc + rate.rating / superMarket.length;
}, 0);
document.write("<h2>The Average Rating of All the Element is</h2> <br>");
document.write(`<b>${Math.round(averageRatings)}</b><br>`);
document.write(
  "--------------------------------------------------------------------------------------"
);

// 2. Calculate the averageHeight of all the element
let averageHeight = superMarket.reduce((acc, height) => {
  return acc + height.height / superMarket.length;
}, 0);
document.write("<h2>The Average Height of All the Element is</h2> <br>");
document.write(`<b>${Math.round(averageHeight)}</b><br>`);
document.write(
  "--------------------------------------------------------------------------------------"
);

// 3. Calculate the averageWidth of all the element
let averageWidth = superMarket.reduce((acc, width) => {
  return acc + width.width / superMarket.length;
}, 0);
document.write("<h2>The Average Width of All the Element is</h2> <br>");
document.write(`<b>${Math.round(averageWidth)}</b><br>`);
document.write(
  "--------------------------------------------------------------------------------------"
);
// 4. Calculate the averagePrice of all the element
let averagePrice = superMarket.reduce((acc, dollar) => {
  return acc + dollar.price / superMarket.length;
}, 0);
document.write("<h2>The Average Price of All the Element is</h2> <br>");
document.write(`<b>${Math.round(averagePrice)}</b>`);
